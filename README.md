...
- ADF test: Strong rejection of the null hypothesis (unit root) indicates that log returns are stationary, which is a required assumption for GARCH and improves learning stability for ______
